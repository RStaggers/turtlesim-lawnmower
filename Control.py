...
if __name__ == '__main__':
    try:
      ...
      #  dx= 2 #The size of the x-step
      #  dy=2 #The size of the y-step
      #  n=21 #The number of iterations to perform. One loop is 4 iterations

       # for i in range (1, n):
        #    x(i)= dx* abs(math.cos(.5*i*math.pi))
         #   X=series.cumsum(x)
          #  y(i) = dy * (math.sin(.5 *i* math.pi)
           # Y = series.cumsum(y)
